...
export const ConnectWithUs = (props) => {
  return (
    <> 
    <Headers title={"ConnectWith us"}/>
       <div className="container-fluid bg-primary bg-appointment mb-5 wow fadeInUp" data-wow-delay="0.1s" >
        ...
        <div className="row gx-5">
            ...
            <div className="col-lg-6">
                <div className="appointment-form h-100 d-flex flex-column justify-content-center text-center p-5 wow zoomIn" data-wow-delay="0.6s">
                    <h1 className="text-white mb-4">Connect </h1>
                    <form>
